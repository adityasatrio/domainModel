...
import rich.domain.model.Order;
import rich.domain.model.OrderItem;
...
public class OrderTest {
	...
	public void richDomainModelMustEnsureToBeConsistentAtAnyTime() {
		...
		OrderItem aGoodBook = new OrderItem(new BigDecimal("30"), 5,"Domain-Driven");
